;(function ($, window, document, undefined) {
  ...
  Foundation.libs.forms = {
    ...
    set_custom_markup: function (sel) {
      ...
      if ($this.hasClass('require-signing')){
        $span.addClass('require-signing')
      }

      $span.toggleClass('checked', $this.is(':checked'));
      $span.toggleClass('disabled', $this.is(':disabled'));
      $span.toggleClass('disabled-option', $this.is('.disabled-option'));
    },
    ...
    assign_id: function ($select, $customSelect) {
      var id = [+new Date(), this.random_str(5)].join('-');
...
$(document).ready(function(){
  $('.custom .checkbox').each(function(){
    console.log('If checkbox suddenly does\'nt work check foundation forms.' )
